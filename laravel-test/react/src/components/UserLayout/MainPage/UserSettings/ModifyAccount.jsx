export default function ModifyAccount(){
    return(
        <div id="ModifyAccount">
            ...
            <div><span>zmień nazwę użytkownika</span><form class="form-inline"><input placeholder="hasło"/><input placeholder="nowa nazwa użytkownika"/><input type="button" value="wyślij" id="ModifyAccountBtn"/></form></div>
